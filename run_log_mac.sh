...
echo ""
echo "=========================================="
echo "MACHINE SPECIFICATIONS — date && system_profiler SPHardwareDataType && sw_vers"
echo "=========================================="
date
...
echo ""
echo "=========================================="
echo "INSTALLING PACKAGES — pip install torch torchvision pillow --index-url https://download.pytorch.org/whl/cpu"
echo "=========================================="
micromamba run -n comp0197-pt pip install torch torchvision pillow --index-url https://download.pytorch.org/whl/cpu

echo ""
echo "=========================================="
echo "TASK 1 TRAINING — micromamba run -n comp0197-pt python task1/train.py"
echo "=========================================="
micromamba run -n comp0197-pt python task1/train.py
...
echo ""
echo "=========================================="
echo "TASK 2 TRAINING — micromamba run -n comp0197-pt python task2/train.py"
echo "=========================================="
micromamba run -n comp0197-pt python task2/train.py
...
echo ""
echo "=========================================="
echo "TASK 1 EVALUATION — micromamba run -n comp0197-pt python task1/task.py"
echo "=========================================="
micromamba run -n comp0197-pt python task1/task.py

echo ""
echo "=========================================="
echo "TASK 2 EVALUATION — micromamba run -n comp0197-pt python task2/task.py"
echo "=========================================="
micromamba run -n comp0197-pt python task2/task.py
